...
gulp.task('del', () => {
   return del([src.style.output.we, src.script.output.we, src.fonts.output.we, src.img.output.we, './index.html']);
});
...
gulp.task('default', gulp.series('del', gulp.parallel('clear', 'fonts', 'img-compress', 'styles', 'scripts', 'pug_index'), 'watch'));